  ...
  template: `
    <div class="dashboard-grid animate-fade-in">
      <section class="welcome-card glass-card full-width" aria-labelledby="welcome-heading">
        <h2 id="welcome-heading" class="gradient-text">
        ...
        <a routerLink="/check-in" class="action-card glass-card">
          <span class="icon-box primary" aria-hidden="true">
            ...
            >
              ...
              <polyline points="22 18 13 18 13 22" />
      ...
      <section
        class="insights-card glass-card"
      ...
      >
        ...
        @if (!isProcessing()) {
          <div class="matches-list" aria-live="polite">
            @for (match of matches(); track match.partnerName) {
              <article class="match-item glass">
                ...
                <span
                  class="score-ring"
                  [attr.aria-label]="
                    'Match score ' + (match.relevanceScore * 100).toFixed(0) + ' percent'
                  "
                >
