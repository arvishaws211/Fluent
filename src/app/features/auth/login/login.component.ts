...
@Component({
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
          ...
          <div class="form-group mt-4">
            <div class="flex justify-between items-center mb-2">
              ...
              <a routerLink="/forgot-password" class="text-xs gradient-text font-semibold">Forgot Password?</a>
            </div>
            <input 
              id="password" 
              type="password" 
          ...
          <div *ngIf="successMessage" class="success-box mt-4">
          ...
          <button (click)="onGoogleLogin()" type="button" class="btn btn-outline w-full mt-4 google-btn">
  ...
  styles: [`
    ...
    .divider-text:not(:empty)::before { margin-right: 1rem; }
    .divider-text:not(:empty)::after { margin-left: 1rem; }
    .google-btn {
      background: rgba(255, 255, 255, 0.05);
