...
export class WayfindingService {
  ...
  private loadMockSensoryData(): void {
    const mockZones: SensoryZone[] = [
      ...
      {
        id: 'aquatics_center',
        center: { lat: 37.7758, lng: -122.4175 },
        radius: 80,
        noiseLevel: 70,
        crowdDensity: 60,
        isQuietZone: false,
      ...
      {
        id: 'athletes_village',
        center: { lat: 37.7765, lng: -122.4205 },
        radius: 100,
        noiseLevel: 15,
        crowdDensity: 20,
        isQuietZone: true,
      ...
      {
        id: 'expo_hall_north',
        center: { lat: 37.7735, lng: -122.421 },
        radius: 120,
        noiseLevel: 85,
        crowdDensity: 80,
        isQuietZone: false,
      ...
      {
        id: 'main_medical_hub',
        center: { lat: 37.7752, lng: -122.422 },
        radius: 50,
        noiseLevel: 25,
        crowdDensity: 15,
        isQuietZone: true,
      ...
      {
        id: 'fan_festival_zone',
        center: { lat: 37.7725, lng: -122.4195 },
        radius: 200,
        noiseLevel: 92,
        crowdDensity: 88,
        isQuietZone: false,
      ...
      {
        id: 'networking_garden',
        center: { lat: 37.776, lng: -122.4155 },
        radius: 70,
        noiseLevel: 20,
        crowdDensity: 15,
        isQuietZone: true,
      ...
      {
        id: 'transport_hub',
        center: { lat: 37.7715, lng: -122.4185 },
        radius: 100,
        noiseLevel: 75,
        crowdDensity: 90,
        isQuietZone: false,
