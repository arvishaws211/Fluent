  ...
  template: `
    ...
    <div class="app-container">
        ...
        <div class="nav-content">
          ...
          @if (user()) {
            <ul class="nav-links" role="list">
              ...
              <li>
                <a routerLink="/check-in" routerLinkActive="active" ariaCurrentWhenActive="page"
                  >Check-in</a
                >
              </li>
              <li>
                <a routerLink="/wayfinding" routerLinkActive="active" ariaCurrentWhenActive="page"
                  >Wayfinding</a
                >
              </li>
              <li>
                <a routerLink="/matchmaking" routerLinkActive="active" ariaCurrentWhenActive="page"
                  >Networking</a
                >
              </li>
              @if (isStaff()) {
                <li>
                  <a routerLink="/runbook" routerLinkActive="active" ariaCurrentWhenActive="page"
                    >Staff Dashboard</a
                  >
                </li>
              }
      ...
      <footer class="glass-card footer">
        ...
        <p class="text-muted">
          Built with Angular 21 Signals, Firestore, Vertex AI, and App Check.
        </p>
      </footer>
    </div>
  `,
